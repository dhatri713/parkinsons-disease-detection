...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BLDSHARED': 'x86_64-apple-darwin13.4.0-clang -bundle -undefined '
              ...
              '-Wl,-rpath,/home/dhatri/Data Science project/venv/lib '
 ...
 'CFLAGS': '-fno-strict-aliasing -Wsign-compare -Wunreachable-code -DNDEBUG '
           ...
           '-fdebug-prefix-map=/home/dhatri/Data Science project/venv=/usr/local/src/conda-prefix '
 ...
 'CONFIGURE_LDFLAGS': '-Wl,-pie -Wl,-headerpad_max_install_names '
                      ...
                      '-L/home/dhatri/Data Science project/venv/lib '
                      '-flto -Wl,-export_dynamic',
 'CONFIG_ARGS': "'--prefix=/home/dhatri/Data Science project/venv' "
 ...
 'LIBFFI_INCLUDEDIR': '/home/dhatri/Data Science project/venv/include',
 'LIBM': '',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/home/dhatri/Data Science project/venv/lib/pkgconfig',
 'LIBPL': '/home/dhatri/Data Science project/venv/lib/python3.8/config-3.8-darwin',
 ...
 'NO_AS_NEEDED': '',
 'OBJECT_OBJS': '\\',
 'OPENSSL_INCLUDES': '-I/home/dhatri/Data Science project/venv/include',
 'OPENSSL_LDFLAGS': '-L/home/dhatri/Data Science project/venv/lib',
